 ...
 * Generated at: 2023-10-16 07:43:25 UTC
...
public final class myPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1697438418711L));
  }
 ...
 if(loginUser == null) { 
      ...
      out.write("            		//웹 애플리캐이션의 디렉토리 구조가 url에 노출되면 보안에 취약하다 \r\n");
      out.write("            		\r\n");
      out.write("            		// 단순한 페이지 요청도 servlet호출해서 servlet 거쳐갈 것(즉, url에는 서블릿 맵핑값만 나타나도록)\r\n");
      out.write("            		location.href = \"");
      out.print( contextPath );
      ...
      out.write("                        <input type=\"checkbox\" name=\"interest\" id=\"sports\" value=\"운동\" checked>\r\n");
      ...
      out.write("				\r\n");
      out.write("				for(let input of inputArr){// 가져온 checkbox 요소들을 전부 반복한다.\r\n");
      out.write("					if(interest.includes(input.value)){//interest에 input.value의 값이 포함되어 있다면 true\r\n");
      out.write("						input.checked = true; // 해당 input의 ckecked는 true로 변경한다.(체크처리)\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("			</script>\r\n");
      out.write("            <br><br>\r\n");
      ...
      out.write("                <button type=\"button\">비밀번호변경</button>\r\n");
      out.write("                <button type=\"button\">회원탈퇴</button>\r\n");
      out.write("            </div>\r\n");
      out.write("\r\n");
      out.write("            <br><br>\r\n");
      out.write("\r\n");
